  ...
  return (
    <dialog id={`my_passenger_modal_${index}`} className="modal">
      <div className="modal-box">
        ...
        <div className="flex flex-col justify-center p-3 gap-3 bg-base-300 my-4 rounded-xl py-5 max-h-75 overflow-y-scroll scrollbar-thin">
          {passengers.length != 0 ? (passengers.map((passenger, index) => {
            return <PassengerItem key={index} rideId={rideId} index={index} passenger={passenger} />;
          })) : (
