        ...
        <div className="flex flex-col justify-center gap-8">
          ...
          <div className="flex items-center justify-between">
            <h1 className="font-bold text-xl">
              Published Rides ({driverRides.length})
            </h1>
          ...
          <div className={`flex flex-col justify-center gap-5`}>
            {gettingRides ? (
                    ...
                    <div className="grid grid-cols-4 w-full pt-5">
                      ...
                      <div className="flex flex-col justify-center gap-3 p-3">
                        ...
                        <button
                          ...
                          onClick={() => {
                            document
                              .getElementById(`my_add_ride_modal_${index}`)
                              .showModal();
                          }}
                        >
                          <PenBox className="size-5" /> Edit Ride
                        </button>
                        <button
                          className="btn btn-primary"
                          onClick={() => {
                            document
                              .getElementById(`my_passenger_modal_${index}`)
                              .showModal();
                          }}
                        >
                          <User2 /> Edit Passengers
                        </button>
                        <button
              ...
              <div className="flex flex-col justify-center items-center">
                <h1 className="font-bold text-xl">No Published Rides Yet</h1>
              </div>
            )}
          </div>
        </div>
